...
INSERT INTO PRODUCT (title, description, price, category, status, created_at, created_by, updated_at) VALUES
...
INSERT INTO MESSAGE (sender_id, receiver_id, product_id, content, is_read) VALUES
(2, 1, 1, 'Is the calculator still available?', FALSE),
(1, 2, 1, 'Yes, still available!', TRUE),
(3, 1, 3, 'Is there any discount possible?', FALSE),
(4, 3, 4, 'Can you share more photos?', FALSE);
