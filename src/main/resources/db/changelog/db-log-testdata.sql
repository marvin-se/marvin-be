...
('Hilal Kartal', NULL, 'kartalh21@itu.edu.tr', '$2a$10$KCujF5.G02ciqrK44bP4v.5BZcuEV/4qQnkHyGQ8lBOkqmg6nAj62', 1, '5383740242', '2025-12-10 16:43:36', TRUE, TRUE, 'Architecture student at ITU. Loves design and creativity.'),
('Selin Yılmaz', NULL, 'yilmazsel21@itu.edu.tr', '$2a$10$KCujF5.G02ciqrK44bP4v.5BZcuEV/4qQnkHyGQ8lBOkqmg6nAj62', 1, '5383740242', '2025-12-10 16:43:36', TRUE, TRUE, NULL),
('Zeliha Melek Bekdemir', NULL, 'bekdemir22@itu.edu.tr', '$2a$10$KCujF5.G02ciqrK44bP4v.5BZcuEV/4qQnkHyGQ8lBOkqmg6nAj62', 1, '5383740242', '2025-12-10 16:43:36', TRUE, TRUE, NULL),
('Alper Daşgın', NULL, 'dasgin21@itu.edu.tr', '$2a$10$KCujF5.G02ciqrK44bP4v.5BZcuEV/4qQnkHyGQ8lBOkqmg6nAj62', 1, '5383740242', '2025-12-10 16:43:36', TRUE, TRUE, NULL);
...
-- =====================
-- TRANSACTIONS  (correct lowercased table name)
-- =====================
INSERT INTO transactions (product_id, buyer_id, seller_id, created_at) VALUES
...
(2, 'verif-token-2-def', 'EMAIL_VERIFICATION', '2025-11-02 09:00:00', '2025-10-01 00:00:00', FALSE),
(3, 'password-token-3-ghi', 'PASSWORD_RESET', '2025-11-03 10:00:00', '2026-01-01 00:00:00', TRUE),
(4, 'verif-token-4-jkl', 'EMAIL_VERIFICATION', '2025-11-04 11:00:00', '2025-11-06 00:00:00', FALSE);
